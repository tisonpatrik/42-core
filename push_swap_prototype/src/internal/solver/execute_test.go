...
func TestApplyCombined_Iteration0(t *testing.T) {
	...
	position := selector.Position{FromIndex: 2, ToIndex: 39, CostA: -4, CostB: 2, Total: 6}
	pushToB := true
	...
	ApplyCombined(ps, position, pushToB)
...
func TestApplyCombined_Iteration1(t *testing.T) {
	...
	position := selector.Position{FromIndex: 0, ToIndex: 0, CostA: 0, CostB: 0, Total: 0}
	pushToB := true
	...
	// Assert - Verify the result
	expectedStackALen := 41
	expectedStackBLen := 459
...
func TestApplyCombined_Iteration2(t *testing.T) {
...
func TestApplyCombined_PushToA(t *testing.T) {
	// Arrange - Set up test data
	stackA := []int{1, 13, 20, 26, 31, 36, 44, 66, 76, 94}
	stackB := []int{367, 380, 464, 466, 355, 320, 278, 306, 407, 255}
	position := selector.Position{FromIndex: 2, ToIndex: 5, CostA: 3, CostB: -2, Total: 5}
	pushToB := false // Push from B to A
